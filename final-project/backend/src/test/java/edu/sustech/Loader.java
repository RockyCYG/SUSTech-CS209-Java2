...
public class Loader {
    ...
    private static void loadQuestion() {
        try (BufferedReader inline = new BufferedReader(new InputStreamReader(new FileInputStream("E:\\360MoveData\\Users\\CYG\\Desktop\\data\\questions.json")))) {
            ...
            for (int i = 0; i < items.length(); i++) {
                ...
                stmt.setInt(5, (item.getInt("create_year") - 956598400) / 31536000 + 2000);
                stmt.addBatch();
                cnt++;
                if (cnt % BATCH_SIZE == 0) {
                    stmt.executeBatch();
    ...
    private static void loadQuestionTags() {
        try (BufferedReader inline = new BufferedReader(new InputStreamReader(new FileInputStream("E:\\360MoveData\\Users\\CYG\\Desktop\\data\\question_tags.json")))) {
            StringBuilder stringBuilder = new StringBuilder();
            String line;
            while ((line = inline.readLine()) != null) {
                stringBuilder.append(line);
    ...
    private static void loadRepos() {
        try (BufferedReader inline = new BufferedReader(new InputStreamReader(new FileInputStream("E:\\360MoveData\\Users\\CYG\\Desktop\\data\\repos.json")))) {
            StringBuilder stringBuilder = new StringBuilder();
            String line;
            while ((line = inline.readLine()) != null) {
                stringBuilder.append(line);
    ...
    private static void loadReposTags() {
        try (BufferedReader inline = new BufferedReader(new InputStreamReader(new FileInputStream("E:\\360MoveData\\Users\\CYG\\Desktop\\data\\repos_tags.json")))) {
            StringBuilder stringBuilder = new StringBuilder();
            String line;
            while ((line = inline.readLine()) != null) {
                stringBuilder.append(line);
    ...
    private static void loadForks() {
        try (BufferedReader inline = new BufferedReader(new InputStreamReader(new FileInputStream("E:\\360MoveData\\Users\\CYG\\Desktop\\data\\record_forks.json")))) {
            StringBuilder stringBuilder = new StringBuilder();
            String line;
            while ((line = inline.readLine()) != null) {
                stringBuilder.append(line);
    ...
    public static void main(String[] args) throws SQLException {
        ...
        defprop.put("password", "123pgcyg");
        defprop.put("database", "cs209");
        ...
        if (con != null) {
            ...
            stmt0.execute(
                    "truncate table " +
                            "questions,question_tags,repos,repos_tags cascade;");
            con.commit();
            stmt0.close();
        }
        loadQuestion();
