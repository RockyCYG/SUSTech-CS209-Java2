  ...
  <div style="padding-top: 20px;">
    <div>
      ...
      <el-input :prefix-icon="Search" style="width: 200px; padding-left: 5px" v-model="title" placeholder="title"
        :disabled="listLoading" clearable />
      <el-input :prefix-icon="Search" style="width: 200px; padding-left: 5px" v-model="score" placeholder=">=score"
        :disabled="listLoading" clearable />
      <el-input :prefix-icon="Search" style="width: 200px; padding-left: 5px" v-model="viewCount"
        placeholder=">=viewCount" :disabled="listLoading" clearable />
      <!-- <el-input :prefix-icon="Search" style="width: 200px; padding-left: 5px" v-model="createYear"
        placeholder="createYear" :disabled="listLoading" clearable /> -->
      <el-date-picker v-model="createYear" type="year" placeholder="createYear" style="width: 200px; padding-left: 5px"
        :disabled="listLoading" clearable />
    ...
    <div>
      <el-table :data="tableData" style="width: 100%; padding-left:0; margin-top: 10px;" v-loading="listLoading"
        ...
        <el-table-column prop="score" label="Score" sortable="custom" width="180" align="center"
          header-align="center" />
        <el-table-column prop="viewCount" label="ViewCount" sortable="custom" width="180" align="center"
          header-align="center" />
        <el-table-column prop="createYear" label="CreateYear" sortable="custom" width="180" align="center"
          header-align="center" />
        <el-table-column prop="tags" label="Tags" width="180" align="center" header-align="center">
          <template #default="{ row }">
            <div v-for="(item, index) in row.tags" :key="index" style="margin-top: 3%;">
              <el-tag :type="tagTypes[index]" effect="dark" round>
                {{ item }}
              </el-tag>
            </div>
          </template>
...
const createYear = ref<number | null>(null);
...
const load = () => {
  ...
  request.get("/stackoverflow/table/pages", {
    params: {
